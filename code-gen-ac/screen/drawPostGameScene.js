...
export default function drawPostGameScene() {
    ...
    const WINNER_PIC = Sprites.create(124, 0, 2.9458333333333337, -4.5001);
    dict.set(0, WINNER_PIC);
    all.add(WINNER_PIC);

    const WINNER = Sprites.create(90, 0, 2.8833333333333333, -4.5);
    dict.set(1, WINNER);
    all.add(WINNER);

    const WON_LABEL = Sprites.create(95, 0.004166666666666667, 1.4708333333333332, -4.5);
