...
export default function drawGameTableScene() {
    ...
    const TIMER_COLON = Sprites.create(269, 0.008333333333333333, 3.6, -4.5);
    dict.set(0, TIMER_COLON);
    all.add(TIMER_COLON);

    all.add(Sprites.create(264, 0.39166666666666666, 3.9458333333333333, -4.5));

    all.add(Sprites.create(268, -0.30416666666666664, 3.925, -4.5));

    const HND_RNK = Sprites.create(122, 0, -2.9125, -4.5);
    dict.set(1, HND_RNK);
    all.add(HND_RNK);
    Sprites.setZ(HND_RNK >> VERSION_BITS, 1.0);

    const PLACE_3 = Sprites.create(102, 0.004166666666666667, -0.004166666666666667, -4.5);
    dict.set(2, PLACE_3);
    all.add(PLACE_3);
    Sprites.setZ(PLACE_3 >> VERSION_BITS, 1.0);

    const PLACE_2 = Sprites.create(101, 0.004166666666666667, -0.004166666666666667, -4.5);
    dict.set(3, PLACE_2);
    all.add(PLACE_2);
    Sprites.setZ(PLACE_2 >> VERSION_BITS, 1.0);

    const WON_LABEL = Sprites.create(104, 0.004166666666666667, -0.004166666666666667, -4.5);
