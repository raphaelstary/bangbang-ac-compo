...
export default function drawMenuScene() {
    ...
    const QUIT_BTNTouch = new TouchArea(0, 0.0296875, 1, 0.190625);
    touches.set(2, QUIT_BTNTouch);
    addTouch(QUIT_BTNTouch);
    ...
    const QUIT_BTNSprite = Sprites.create(6, 0, 6.133333333333334, -8);
    dict.set(2, QUIT_BTNSprite);
    all.add(QUIT_BTNSprite);
